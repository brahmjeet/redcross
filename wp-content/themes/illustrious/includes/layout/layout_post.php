...
function cpotheme_post_pagination(){
	...
	//First Page Link
	if($current_page > 1){
		$out .= '<a class="page" href="'.esc_url(get_pagenum_link(1)).'">'.__('First Page', 'cpotheme').'</a>';
	}
	...
	if($current_page < $total_pages){
		$out .= '<a class="page" href="'.esc_url(get_pagenum_link($total_pages)).'">'.__('Last Page', 'cpotheme').'</a>';
	}
